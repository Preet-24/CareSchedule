...
namespace CareSchedule.Services.Implementation
{
    public class RosterService(
        ...
        IUnitOfWork uow) : IRosterService
    {
        private readonly IShiftTemplateRepository _shiftRepo = shiftRepo;
        private readonly IRosterRepository _rosterRepo = rosterRepo;
        private readonly IRosterAssignmentRepository _assignRepo = assignRepo;
        private readonly IOnCallCoverageRepository _onCallRepo = onCallRepo;
